...
int WINAPI WinMain(HINSTANCE, HINSTANCE, LPSTR, int) {
	...
	Matrix4x4 rotateXMatrix = MyMtMatrix::MakeRotateXMatrix(rotate.x);
	Matrix4x4 rotateYMatrix = MyMtMatrix::MakeRotateYMatrix(rotate.y);
	Matrix4x4 rotateZMatrix = MyMtMatrix::MakeRotateZMatrix(rotate.z);
